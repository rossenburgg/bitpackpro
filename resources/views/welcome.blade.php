...
<head>
  ...
  <!-- Title -->
  <title>BitPack | Buy and sell cryptocurrencies within Ghana, nigeria and beyound with your local payment methods - Mobile money, credit cards, etc.</title>
...
<body>
  ...
  <header id="header" class="navbar navbar-expand-lg navbar-end navbar-absolute-top navbar-dark navbar-show-hide"
              ...
              <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="MoreMegaMenu" style="min-width: 40rem;">
                ...
                <div class="navbar-dropdown-menu-promo">
                  ...
                  <div class="navbar-dropdown-menu-promo-item">
                    <!-- Promo Link -->
                    <a class="navbar-dropdown-menu-promo-link active" href="/">
                      <div class="d-flex">
    ...
    <div class="container">
      <nav class="js-mega-menu navbar-nav-wrap">
        <!-- Default Logo -->
        <a class="navbar-brand" href="/" aria-label="BitPack">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="navbar-absolute-top-scroller">
            <ul class="navbar-nav">
              ...
              <li class="hs-has-mega-menu nav-item">
                <a id="landingsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" aria-current="page" href="#" role="button" aria-expanded="false">Tools</a>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm">
                            <div class="mb-3">
                              ...
                              <a class="dropdown-item active" href="./landing-app-payment.html">Payment</a>
              ...
              <!-- Button -->
              <li class="nav-item">
                <a class="btn btn-light btn-transition" href="{{ route('register') }}" >Create an account</a>
              </li>
              <!-- End Button -->
            </ul>
          </div>
  ...
  <main id="content" role="main">
        ...
        <div class="row align-items-lg-center">
          <div class="col-lg-5 mb-7 mb-lg-0">
            ...
            <div class="mb-6">
              ...
              <p class="lead text-white-70">Much more than a bank, Bitpack is the ideal, fastest and most convenient financial and cryptotrading co-driver to work with peace of mind.</p>
            </div>
            <!-- End Title & Description -->

            <div class="d-grid d-sm-flex gap-3">
              <a class="btn btn-primary btn-transition" href="{{ route('login') }}">Log in</a>
              <a class="btn btn-ghost-light btn-transition " data-bs-toggle="modal" data-bs-target="#signupModal" href="#">Get started <i class="bi-chevron-right small ms-1"></i></a>
            ...
            <div class="position-relative">
              ...
              <div class="d-none d-sm-block position-absolute bottom-0 end-0 zi-1 mb-n5 me-n5" style="max-width: 20rem;" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="card bg-warning" style="background-image: url(./assets/svg/components/wave-pattern-light.svg);">
                  <div class="card-body">
                    <h4 class="card-title">Trade quickly</h4>
                    <p class="card-text text-dark">Bitpack lets you buy or sell cryptocurrencies quicker than ever.</p>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-2">
                        <h5 class="card-title mb-0">Enock Acquah</h5>
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
          <div class="col-lg-5 mb-9 mb-lg-0">
            ...
            <div class="mb-5">
              ...
              <p>When paying in stores, BitPack Pay doesn't share your actual card number, so your information stays secure. Plus, you can check out faster and easier.</p>
            </div>
            <!-- End Heading -->
            ...
            <p class="small">See how to send money with BitPack Pay.</p>
          </div>
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
          <div class="col-lg-5 order-lg-2 mb-9 mb-lg-0">
            ...
            <div class="mb-5">
              ...
              <p>Use BitPack Pay to make purchases in all kinds of apps. Pay for a ride, a pizza delivery, or a new pair of sneakers — with just a touch. Checking out is fast, simple, and secure.</p>
            </div>
            <!-- End Heading -->
      ...
      <div class="container content-space-t-2 content-space-t-lg-3 content-space-b-lg-2">
        <div class="row justify-content-lg-between align-items-lg-center">
          <div class="col-lg-5 mb-9 mb-lg-0">
            <!-- Heading -->
            <div class="mb-4">
              <h2>Get paid and use the cash. All with BitPack Pay.</h2>
              <p>When you receive money it's added to your BitPack Pay Cash card that lives in the Wallet app.</p>
            </div>
            <!-- End Heading -->
            
            <!-- List Checked -->
            <ul class="list-checked list-checked-soft-bg-dark list-checked-lg">
              <li class="list-checked-item">When you pay with a debit or credit card, BitPack Pay doesn't keep transaction information that can be tied back to you.</li>
              <li class="list-checked-item">When you use BitPack Pay Cash, information is stored only for troubleshooting.</li>
              <li class="list-checked-item">You can also add your student ID card to BitPack Wallet to access places like your dorm and the library.</li>
            </ul>
            <!-- End List Checked -->
          </div>
          <!-- End Col -->
      ...
      <div class="w-lg-75 mx-lg-auto">
        <div class="d-block d-sm-flex align-items-sm-center">
          ...
          <div class="flex-grow-1 ms-4">
            <h4>Grow your business with BitPack Pay</h4>
            <p class="mb-0">From startups to Fortune 500s, explore how millions of businesses use BitPack Pay to start and scale their companies. <a class="link" href="#">See our customers <i class="bi-chevron-right small"></i></a></p>
          </div>
        </div>
      </div>
      <!-- End CTA -->
          ...
          <div class="col-sm-6 col-lg-4">
            ...
            <div class="card shadow-none">
              <div class="card-body">
                ...
                <div class="mb-auto">
                  <p class="card-text">With BitPack Pay, you can check out across the web and in apps without having to enter any payment information.</p>
                </div>
              </div>
          ...
          <div class="col-sm-6 col-lg-4">
            ...
            <div class="card bg-primary">
              <div class="card-body">
                ...
                <div class="mb-auto">
                  <p class="card-text text-white">From boarding passes to transit and movie tickets, there's pretty much nothing you can't store with BitPack Pay.</p>
                </div>
              </div>
          ...
          <div class="col-sm-6 col-lg-4">
            ...
            <div class="card shadow-none">
              <div class="card-body">
                ...
                <div class="mb-auto">
                  <p class="card-text">I love BitPack Pay for cash back, reward points and fraud protection – just like when you're swiping your card.</p>
                </div>
              </div>
              ...
              <div class="card-footer pt-0">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <p class="card-text small">BitPack Pay user</p>
                  </div>
                </div>
                <!-- End Media -->
              </div>
      ...
      <div class="row align-items-lg-center">
        ...
        <div class="col-md-5 col-lg-4">
          <div class="ps-md-4">
            ...
            <p>Believe basic computer skills are all you need to plan projects with BitPack Pay.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container content-space-2 content-space-t-lg-4 content-space-b-lg-3">
      ...
      <div class="w-lg-50 text-center mx-lg-auto mb-5">
        ...
        <p>From boarding passes to movie tickets, there's pretty much nothing you can't store with BitPack Pay. Plus, you can take your money further with exclusive offers, discounts, and even reminders to use your loyalty card when you enter the store.</p>
      </div>
      <!-- End Heading -->
      ...
      <div class="container content-space-2">
        <div class="row justify-content-lg-between align-items-lg-center">
          <div class="col-md mb-5 mb-md-0">
            <h2 class="text-white mb-0">Create better experiences with BitPack Pay</h2>
          </div>
          <!-- End Col -->
  ...
  <footer class="container content-space-2 content-space-t-lg-3">
    ...
    <div class="row mb-10">
      ...
      <div class="col-sm-4 col-md-3 mb-3 mb-sm-0">
        ...
        <ul class="list-unstyled list-py-1">
          <li><a class="text-body" href="#">About</a></li>
          <li><a class="text-body" href="#">Services</a></li>
          <li><a class="text-body" href="#">Careers <span class="badge bg-warning text-dark rounded-pill ms-1">We're hiring</span></a></li>
          <li><a class="text-body" href="#">Blog</a></li>
          <li><a class="text-body" href="#">Shop with us</a></li>
        </ul>
        <!-- End List -->
      </div>
      ...
      <div class="col-sm-4 col-md-3 mb-3 mb-sm-0">
        <!-- List -->
        <ul class="list-unstyled list-py-1">
          <li><a class="text-body" href="#">Account</a></li>
          <li><a class="text-body" href="#">My tasks</a></li>
          <li><a class="text-body" href="#">Projects</a></li>
          <li><a class="text-body" href="#">Edit profile</a></li>
          <li><a class="text-body" href="#">Activity</a></li>
        </ul>
        <!-- End List -->
      </div>
      ...
      <div class="col-sm-4 col-md-3 mb-3 mb-sm-0">
        ...
        <ul class="list-unstyled list-py-1">
          <li>
            <a class="text-body" href="page-pricing.html" target="_blank">
              Pricing
              <i class="bi-box-arrow-up-right small ms-1"></i>
            </a>
          </li>
          <li>
            <a class="text-body" href="demo-help-desk/index.html" target="_blank">
              Help
              <i class="bi-box-arrow-up-right small ms-1"></i>
            </a>
          </li>
          <li>
            <a class="text-body" href="page-terms.html" target="_blank">
              Terms &amp; Conditions
              <i class="bi-box-arrow-up-right small ms-1"></i>
            </a>
          </li>
          <li>
            <a class="text-body" href="page-privacy.html" target="_blank">
              Privacy &amp; Policy
              <i class="bi-box-arrow-up-right small ms-1"></i>
            </a>
          </li>
    ...
    <div class="row align-items-sm-center">
      <div class="col-sm mb-4 mb-sm-0">
        <p class="small mb-0">&copy; BitPack. 2021 Htmlstream. All rights reserved.</p>
      </div>
      <!-- End Col -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div id="signupModalFormSignupWithEmail" style="display: none; opacity: 0;">
            ...
            <form id="formAuthentication" class="js-validate need-validate" action="{{ route('register') }}" method="POST">
            @csrf
              <!-- Form -->
              <div class="mb-3">
                <label class="form-label" for="signupModalFormSignupEmail">Your username</label>
                <input type="text" class="form-control form-control-lg" name="name" id="username" placeholder="satoshi123" aria-label="email@site.com" autofocus value="{{ old('name') }}" required>
                <span class="invalid-feedback">Please choose a unique username.</span>
              </div>

              <div class="mb-3">
                <label class="form-label" for="signupModalFormSignupEmail">Your email</label>
                <input type="email" class="form-control form-control-lg" name="email" id="email" placeholder="email@site.com" aria-label="email@site.com" value="{{ old('email') }}" required>
                <span class="invalid-feedback">Please enter a valid email address.</span>
              </div>
              <!-- End Form -->
