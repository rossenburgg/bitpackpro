...
<p>You can check complete list of box icons from <a href="https://fontawesome.com/" target="_blank">https://fontawesome.com</a></p>
...
<div class="d-flex flex-wrap" id="icons-container">
  ...
  <div class="card icon-card cursor-pointer text-center  mb-4 mx-2">
    <div class="card-body"> <i class="fab fa-acquisitions-incorporated mb-2"></i>
      <p class="icon-name text-capitalize text-truncate mb-0">acquisitions-incorporated</p>
    </div>
  </div>
  <div class="card icon-card cursor-pointer text-center  mb-4 mx-2">
