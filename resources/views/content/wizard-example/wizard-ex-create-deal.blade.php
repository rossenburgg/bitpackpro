      ...
      <div id="review-complete" class="content">
        <div class="row g-3">
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <img src="{{asset('assets/img/illustrations/girl-checkout-offer-'.$configData['style'].'.png')}}" class="img-fluid w-px-350 p-4" alt="shopping girl" data-app-dark-img="illustrations/girl-checkout-offer-dark.png" data-app-light-img="illustrations/girl-checkout-offer-light.png">
          </div>
          <div class="col-12 d-flex justify-content-between">
            <button class="btn btn-primary btn-prev"> <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
              <span class="align-middle d-sm-inline-block d-none">Previous</span>
