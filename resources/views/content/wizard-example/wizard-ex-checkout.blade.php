        ...
        <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          ...
                          <button type="button" class="btn btn-sm btn-label-secondary">Move to wishlist</button>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-xl-4">
            <div class="border rounded p-3 mb-3">
              ...
              <h6>Price Details</h6>
              <dl class="row mb-0">
                <dt class="col-sm-6 fw-normal">Bag Total</dt>
                <dd class="col-sm-6 text-end">$1198.00</dd>

                <dt class="col-sm-6 fw-normal">Coupon Discount</dt>
                <dd class="col-sm-6 text-success text-end"> -$98.00</dd>

                <dt class="col-sm-6 fw-normal">Order Total</dt>
                <dd class="col-sm-6 text-end">$1100.00</dd>

                <dt class="col-sm-6 fw-normal">Delivery Charges</dt>
                <dd class="col-sm-6 text-end"><s>$5.00</s> <span class="badge bg-label-success">Free</span></dd>

                <hr>

                <dt class="col-sm-6">Total</dt>
                <dd class="col-sm-6 fw-semibold text-end mb-0">$1100.00</dd>
              </dl>
            </div>
            <div class="d-grid">
          ...
          <div class="col-xl-3">
            <div class="border rounded p-3">
              ...
              <dl class="row">
                ...
                <dt class="col-sm-6">Deliver to:</dt>
                <dd class="col-sm-6 fw-semibold text-end mb-0"><span class="badge bg-label-primary">Home</span></dd>
              </dl>
              <!-- Address Details -->
              <address>
