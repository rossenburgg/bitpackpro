        ...
        <table class="table text-nowrap">
          ...
          <tbody class="table-border-bottom-0">
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <img src="{{asset('assets/img/icons/products/oneplus.png')}}" alt="Oneplus" height="32" width="32" class="me-2">
                  <div class="d-flex flex-column">
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <img src="{{asset('assets/img/icons/products/magic-mouse.png')}}" alt="Apple" height="32" width="32" class="me-2">
                  <div class="d-flex flex-column">
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <img src="{{asset('assets/img/icons/products/imac-pro.png')}}" alt="Apple" height="32" width="32" class="me-2">
                  <div class="d-flex flex-column">
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <img src="{{asset('assets/img/icons/products/note10.png')}}" alt="Samsung" height="32" width="32" class="me-2">
                  <div class="d-flex flex-column">
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <img src="{{asset('assets/img/icons/products/iphone.png')}}" alt="Apple" height="32" width="32" class="me-2">
                  <div class="d-flex flex-column">
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <img src="{{asset('assets/img/icons/products/mi-tv.png')}}" alt="Xiaomi" height="32" width="32" class="me-2">
                  <div class="d-flex flex-column">
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <img src="{{asset('assets/img/icons/products/logitech-mx.png')}}" alt="Logitech" height="32" width="32" class="me-2">
                  <div class="d-flex flex-column">
